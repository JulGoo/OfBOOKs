	...
	<div id="wrapper">
		...
		<ul
			...
			<a
				...
				<div class="sidebar-brand-text mx-3" style="text-transform: none;">OfBOOKs</div>
			</a>
			...
			<li class="nav-item active"><a class="nav-link"
				href="index.html"> <i class="fas fa-fw fa-tachometer-alt"></i> <span>도서
						검색</span></a></li>
			...
			<div id="content">
				...
				<nav
					...
					<ul class="navbar-nav ml-auto">
						...
						if (userIDs == null) {
						%>
						<li style="margin-right: 18px;"><a href="login.do"
							style="font-weight: bold; text-decoration-line: none;">로그인</a></li>
						<li style="margin-right: 10px;"><a href="register.do"
							style="font-weight: bold; text-decoration-line: none;">회원가입</a></li>
						<%
						} else {
						%>
						<!-- 로그인 시 -->
